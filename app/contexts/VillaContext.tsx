...
interface VillaContextType {
    ...
    setAdditionalFeatures: SetState<string[]>;
}

const VillaContext = createContext<VillaContextType | undefined>(undefined);

export const VillaProvider: React.FC<{ children: React.ReactNode }> = ({
    children,
}) => {
